...
sections = [
 ...
 ("S-02","Part I — Foundations","Core thesis and central invariants",["R-CORE-01","R-CORE-02","R-CORE-03","R-CORE-04","R-CORE-05","R-CORE-06","R-CORE-07","R-CORE-08","R-CORE-09","R-CORE-10","R-CORE-11","R-CORE-12"],prov("27485-27654","41320-41770"),None),
 ...
 ("S-15","Part V — Concurrency","Actors and deterministic scheduling",["R-ACTOR-01","R-ACTOR-02","R-ACTOR-03","R-ACTOR-04","R-ACTOR-05","R-ACTOR-06","R-ACTOR-07","R-ACTOR-08","R-ACTOR-09"],prov("25457-26108","24069-25428"),"U-03;U-05"),
 ...
 ("S-17","Part VI — Persistence","Canonical serialization (15A frozen wire format)",["R-CANON-01","R-CANON-02","R-CANON-03","R-CANON-04","R-CANON-05","R-CANON-06","R-CANON-07","R-CANON-08","R-CANON-09","R-CANON-10","R-CANON-11","R-CANON-12"],prov("32936-33707","29451-31298","34987-35024"),"C-02"),
 ("S-18","Part VI — Persistence","Persistence protocol (15B)",["R-PERSIST-01","R-PERSIST-02","R-PERSIST-03","R-PERSIST-04","R-PERSIST-05","R-PERSIST-06","R-PERSIST-07"],prov("35078-35258","33757-34916"),"U-02;U-16"),
 ("S-19","Part VI — Persistence","Crash recovery",["R-RECOV-01","R-RECOV-02","R-RECOV-03","R-RECOV-04","R-RECOV-05","R-RECOV-06","R-RECOV-07"],prov("35159-35258","26109-27484"),"U-15;U-17"),
...
milestones = [
 ...
 ("M1","Canonical serialization",["golden vectors pass","round trips pass","malformed inputs reject","duplicate keys reject","canonical bytes deterministic"],["R-CANON-01","R-CANON-02","R-CANON-03","R-CANON-04","R-CANON-05","R-CANON-06","R-CANON-07","R-CANON-08","R-CANON-09","R-CANON-10","R-CANON-11","R-CANON-12"]),
 ...
 ("M4","Capability / Attenuation",["CAP-DERIVE-NO-AMPLIFICATION","revocation","expiration","lexical capability binding","independent reference capability algebra"],["R-CAP-01","R-CAP-02","R-CAP-03","R-CAP-04","R-CAP-05","R-CAP-06","R-CAP-07","R-CAP-08","R-CAP-09","R-KERN-01","R-KERN-02","R-KERN-03","R-KERN-04","R-KERN-05","R-MARSHAL-05"]),
 ("M5","Effects",["authorization","budget gates","deadline","host policy","EffectId","EffectDigest","durable issuance","receipt validation"],["R-EFFECT-01","R-EFFECT-02","R-EFFECT-03","R-EFFECT-04","R-EFFECT-05","R-EFFECT-06","R-EFFECT-07","R-DUR-01","R-DUR-02","R-DUR-03","R-DUR-04","R-DUR-05","R-HOST-01","R-HOST-02","R-HOST-03","R-HOST-04","R-HOST-05","R-EFFECT-08","R-CORE-11","R-CORE-12"]),
 ("M6","Actors",["FIFO scheduler","FIFO mailbox","spawn isolation","send/receive","delegation","blocked/wakeup semantics"],["R-ACTOR-01","R-ACTOR-02","R-ACTOR-03","R-ACTOR-04","R-ACTOR-05","R-ACTOR-06","R-ACTOR-07","R-ACTOR-08","R-MARSHAL-01","R-MARSHAL-02","R-MARSHAL-03","R-MARSHAL-04","R-MARSHAL-06","R-ACTOR-09"]),
 ("M7","Persistence",["WAL","snapshot","effect journal","checksum","sequence continuity","recovery"],["R-PERSIST-01","R-PERSIST-02","R-PERSIST-03","R-PERSIST-04","R-PERSIST-05","R-PERSIST-06","R-RECOV-01","R-RECOV-03","R-RECOV-04","R-RECOV-05","R-RECOV-06","R-PERSIST-07"]),
 ...
 ("M10","Crash/recovery gate",["T0..T6 all produce the frozen expected classification"],["R-RECOV-02","R-TEST-08","R-DUR-04","R-PERSIST-07"]),
...
crates = [
 ...
 ("ror-kernel","CapabilityKernel: derive/authorize/validate/revocation; authority storage",["R-CAP-02","R-CAP-03","R-CAP-04","R-CAP-05","R-CAP-06","R-CAP-07","R-CAP-08","R-CAP-09","R-KERN-01","R-KERN-02","R-KERN-03","R-KERN-04","R-KERN-05","R-PERSIST-07","R-CORE-11","R-TRUST-03"],["ror-core"]),
 ("ror-runtime","CEK machine, actors, scheduler, effects, marshalling",["R-ARCH-01","R-CORE-08","R-CEK-01","R-CEK-02","R-CEK-03","R-CEK-04","R-CEK-05","R-CEK-06","R-CEK-07","R-EFFECT-01","R-EFFECT-02","R-EFFECT-03","R-EFFECT-04","R-EFFECT-05","R-EFFECT-06","R-EFFECT-07","R-EFFECT-08","R-ACTOR-01","R-ACTOR-02","R-ACTOR-03","R-ACTOR-04","R-ACTOR-05","R-ACTOR-06","R-ACTOR-07","R-ACTOR-08","R-MARSHAL-01","R-MARSHAL-02","R-MARSHAL-03","R-MARSHAL-04","R-MARSHAL-05","R-MARSHAL-06","R-CORE-11","R-ACTOR-09","R-CORE-12"],["ror-core","ror-kernel"]),
 ("ror-persistence","WAL, snapshots, effect journal, recovery",["R-DUR-01","R-DUR-02","R-DUR-03","R-DUR-04","R-DUR-05","R-PERSIST-01","R-PERSIST-02","R-PERSIST-03","R-PERSIST-04","R-PERSIST-05","R-PERSIST-06","R-RECOV-01","R-RECOV-02","R-RECOV-03","R-RECOV-04","R-RECOV-05","R-RECOV-06","R-RECOV-07","R-KERN-05","R-PERSIST-07","R-TRUST-05"],["ror-core"]),
