...
**Adding all 2 keeps the crate layer acyclic** (18 edges, 0 non-trivial SCCs). The dependency levels of `dep/02` §1 change for **no crate at all** Every gap in this section is therefore cheap to close: none of them introduces a cycle, and none forces a workspace re-ordering beyond the one undecided edge.
