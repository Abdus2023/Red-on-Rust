...
| `spec/09-unresolved-decisions.md`:147 | ``### U-28 — Which `MachineEvent` names govern`` | the decision this entry escalates to; added by the same sweep |
...
| `spec/09-unresolved-decisions.md`:154 | ``### U-29 — Which `CanonicalError` shape governs`` | the decision this entry escalates to; added by the same sweep |
...
| `spec/09-unresolved-decisions.md`:133 | ``### U-26 — Which layer owns the name `StepResult`?`` | the decision this entry escalates to; added by the same sweep |
...
| `spec/09-unresolved-decisions.md`:140 | ``### U-27 — Which `ActorStatus` shape governs`` | the decision this entry escalates to; added by the same sweep |
...
| `spec/09-unresolved-decisions.md`:163 | ``### U-30 — Which payload does `MarshalledValue` carry`` | U-30, the decision this finding needs |
...
| `spec/09-unresolved-decisions.md`:171 | ``### U-31 — Which field set is `Authority`'s`` | U-31 |
...
| `spec/09-unresolved-decisions.md`:187 | `### U-33 — Which reference-model declarations govern` | U-33 |
...
| `spec/09-unresolved-decisions.md`:179 | ``### U-32 — Does the durable `WalFrame` carry `payload_length``` | U-32 |
...
| `spec/09-unresolved-decisions.md`:171 | ``### U-31 — Which field set is `Authority`'s`` | U-31, which also rules on the kernel's arena |
...
| `spec/09-unresolved-decisions.md`:195 | `### U-34 — Which turn-[31]/turn-[32] state structs govern` | U-34 |
...
| `spec/09-unresolved-decisions.md`:187 | `### U-33 — Which reference-model declarations govern` | U-33, which rules on the twelve `Ref*` names |
...
| `spec/09-unresolved-decisions.md`:207 | `### U-35` | U-35 rules on the governing shape |
...
| File:line | Text at that line | Note |
|---|---|---|
| `spec/01-canonical-specification.md`:510 | `Block → parse → NormalizedAST` | the single-ordering rendering |
...
| File:line | Text at that line | Note |
|---|---|---|
| `spec/09-unresolved-decisions.md`:76 | ``the variant set of `ReconciliationOutcome` is never enumerated`` | the false premise, corrected by this dictionary |
