...
**Status: DRAFT FOR SPECIFICATION-OWNER ADOPTION — not applied.** This file
changes no frozen text. Per R-SCOPE-03 the substitution must be reversed by
an explicit frozen addendum; this draft is the mechanical input for it.
