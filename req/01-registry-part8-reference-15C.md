...
- NORMATIVE-LEVEL: MUST
- STATEMENT: For gated operations, generated tests attach observable markers to every stage (capability evaluation, target evaluation, each argument, authorization, budget, deadline, host policy) so short-circuiting is observable.
- PRECONDITIONS: gated-operation testing
- POSTCONDITIONS: per-stage markers are emitted and compared
- INVARIANTS: —
...
- NORMATIVE-LEVEL: SHOULD
- STATEMENT: Generation is layered — seed, structure, type/environment-aware, capability — rather than unrestricted random syntax.
- PRECONDITIONS: program generation
...
- REQ-ID: REQ-TEST-041
- CATEGORY: test-infrastructure
- SOURCE: Red-on-Rust.md L36635–36665([48] 15C.31 Counterexample Format); spec/01 S-21 R-TEST-02
- NORMATIVE-LEVEL: MUST
...
- REQ-ID: REQ-TEST-050
- CATEGORY: test-infrastructure
- SOURCE: Red-on-Rust.md L36935–36976([48] 15C.40 Determinism Requirement); spec/01 S-21 R-TEST-02
- NORMATIVE-LEVEL: MUST
