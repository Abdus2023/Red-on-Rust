...
| §4 review-only | 96 |
| All other records (executable method stated: conformance tag, mutation M0xx, milestone gate, crash matrix, golden vector, property test, or differential test) | 433 |
| **Total registry records** | **545** |
